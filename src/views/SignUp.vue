    ...
    <div class="bg-white py-8 px-6 shadow rounded-lg sm:px-10">
      <form class="mb-0 space-y-6" action="#" method="POST">
        <div>
          ...
          <div class="mt-1">
            <input id="email" name="email" type="email" autocomplete="email" required class="w-full border border-gray-300 px-3 py-3 rounded-lg shadow-sm focus:outline-none focus:border-gray-400 focus:ring-1 focus:ring-red-400" />
          </div>
        </div>
        ...
        <div>
          ...
          <div class="mt-1">
            <input id="password" name="password" type="password" autocomplete="current-password" required class="w-full border border-gray-300 px-3 py-3 rounded-lg shadow-sm focus:outline-none focus:border-gray-400 focus:ring-1 focus:ring-red-400" />
          </div>
        </div>
        ...
        <div>
          ...
          <div class="mt-1">
            <select name="company-size" id="company-size" class=" w-full border border-gray-300 px-3 py-3 rounded-lg shadow-sm focus:outline-none focus:border-gray-400 focus:ring-1 focus:ring-red-400">
        ...
        <div class="flex items-center">
          <input id="terms-and-privacy" name="terms-and-privacy" type="checkbox" class="rounded border-green-500 text-green-800 focus:ring-1 focus:ring-black" />
